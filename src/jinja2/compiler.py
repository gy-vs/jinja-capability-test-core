...
class CodeGenerator(NodeVisitor):
    ...
    def _filter_test_common(self, node, frame, is_filter):
        ...
        # When inside an If or CondExpr frame, allow the filter or test
        # to be undefined at compile time and only raise an error if
        # it's actually called at runtime. See pull_dependencies.
